...
const (
	...
	RPI_PROCESSOR_BROADCOM_2835
    RPI_PROCESSOR_BROADCOM_2836
)
...
var productmap1 = map[uint32]uint32{
	0x02: RPI_MODEL_B,
	0x03: RPI_MODEL_B,
	0x04: RPI_MODEL_B,
	0x05: RPI_MODEL_B,
...
var memorymap1 = map[uint32]uint32{
...
var processormap1 = map[uint32]uint32{
	0x02: RPI_PROCESSOR_BROADCOM_2835,
	0x03: RPI_PROCESSOR_BROADCOM_2835,
	0x04: RPI_PROCESSOR_BROADCOM_2835,
	0x05: RPI_PROCESSOR_BROADCOM_2835,
	0x06: RPI_PROCESSOR_BROADCOM_2835,
	0x07: RPI_PROCESSOR_BROADCOM_2835,
	0x08: RPI_PROCESSOR_BROADCOM_2835,
	0x09: RPI_PROCESSOR_BROADCOM_2835,
	0x0D: RPI_PROCESSOR_BROADCOM_2835,
	0x0E: RPI_PROCESSOR_BROADCOM_2835,
	0x0F: RPI_PROCESSOR_BROADCOM_2835,
	0x10: RPI_PROCESSOR_BROADCOM_2835,
	0x11: RPI_PROCESSOR_BROADCOM_2835,
	0x12: RPI_PROCESSOR_BROADCOM_2835,
	0x13: RPI_PROCESSOR_BROADCOM_2835,
	0x14: RPI_PROCESSOR_BROADCOM_2835,
	0x15: RPI_PROCESSOR_BROADCOM_2835,
}

var manufacturermap1 = map[uint32]uint32{
...
var manufacturermap2 = map[uint32]uint32{
...
var productmap2 = map[uint32]uint32{
	0<<4: RPI_MODEL_A,
	1<<4: RPI_MODEL_B,
...
var processormap2 = map[uint32]uint32{
	0<<12: RPI_PROCESSOR_BROADCOM_2835,
	1<<12: RPI_PROCESSOR_BROADCOM_2836,
}

var memorymap2 = map[uint32]uint32{
	0<<20: RPI_MEMORY_256MB,
	1<<20: RPI_MEMORY_512MB,
	2<<20: RPI_MEMORY_1024MB,
}

var productstringmap = map[uint32]string{
...
var processorstringmap = map[uint32]string{
	RPI_PROCESSOR_UNKNOWN: "unknown",
	RPI_PROCESSOR_BROADCOM_2835: "BCM2835",
	RPI_PROCESSOR_BROADCOM_2836: "BCM2836",
}

var manufacturerstringmap = map[uint32]string{
...
func (this *State) GetModel() (*Model, error) {
	...
	if (revision & RPI_REVISION_ENCODING_MASK) != 0 {
		...
		model.Product = productmap2[revision & RPI_REVISION_PRODUCT_MASK]
		model.PCBRevision = revision & RPI_REVISION_PCB_MASK
		model.Processor = processormap2[revision & RPI_REVISION_PROCESSOR_MASK]
		model.Manufacturer = manufacturermap2[revision & RPI_REVISION_MANUFACTURER_MASK]
		model.MemoryMB = memorymap2[revision & RPI_REVISION_MEMORY_MASK]
	} else {
		// Raspberry Pi 1 style revision coding
		model.Product = productmap1[revision]
		model.PCBRevision = pcbmap1[revision]
		model.Processor = processormap1[revision]
		model.Manufacturer = manufacturermap1[revision]
		model.MemoryMB = memorymap1[revision]
	}
