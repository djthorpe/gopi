...
func (this *servicedb2) addLookup(name string) {
	this.Mutex.Lock()
	defer this.Mutex.Unlock()
...
func (this *servicedb2) popLookup() string {
	this.Mutex.Lock()
	defer this.Mutex.Unlock()
...
func (this *servicedb2) backgroundTask(stop <-chan struct{}) {
...
func (this *servicedb2) backgroundLookup(ctx context.Context, service string) error {
