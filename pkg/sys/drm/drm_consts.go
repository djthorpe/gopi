...
const (
	...
	DRM_MODE_ATOMIC_TEST_ONLY          = C.DRM_MODE_ATOMIC_TEST_ONLY
	DRM_MODE_ATOMIC_NONBLOCK           = C.DRM_MODE_ATOMIC_NONBLOCK
	DRM_MODE_ATOMIC_ALLOW_MODESET      = C.DRM_MODE_ATOMIC_ALLOW_MODESET
)
