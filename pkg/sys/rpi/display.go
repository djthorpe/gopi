...
func (d DXDisplayId) String() string {
	...
	case DX_DISPLAYID_HDMI0:
		return "DX_DISPLAYID_HDMI0"
	...
	case DX_DISPLAYID_HDMI1:
		return "DX_DISPLAYID_HDMI1"
	case DX_DISPLAYID_FORCE_TV2:
		return "DX_DISPLAYID_FORCE_TV2"
	default:
